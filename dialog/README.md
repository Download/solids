  ...
  <aside id="mdc-dialog-with-list"
    ...
    <div class="mdc-dialog__surface">
      ...
      <section id="mdc-dialog-with-list-description" class="mdc-dialog__body mdc-dialog__body--scrollable">
       	<ul class="solid_list">
          <li class="list_item">None</li>
          <li class="list_item">Callisto</li>
          <li class="list_item">Ganymede</li>
          <li class="list_item">Luna</li>
          <li class="list_item">Marimba</li>
          <li class="list_item">Schwifty</li>
          <li class="list_item">Callisto</li>
          <li class="list_item">Ganymede</li>
          <li class="list_item">Luna</li>
          <li class="list_item">Marimba</li>
